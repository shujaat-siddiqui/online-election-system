<%@ Page Title="Candidates" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdCandidates.aspx.cs" Inherits="Online_Election_System.AdCandidates" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="height:auto; width:auto; background-color:#c8b9b9">
        ...
        <div style=" width:auto; margin-top:5px; margin-bottom:5%">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=DESKTOP-SNGIH0I\SHUJAAT;Initial Catalog=OnlineElectionSystem;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [idnumber], [Name], [Gender], [DOB], [Party], [ActiveStatus] FROM [Candidate]"></asp:SqlDataSource>
        ...
        <div style="height:200px; width:700px; margin-top:5px; padding-left:4px; padding-top:4px; color:black; font-size:25px; font-family:Tahoma; font:bold">
            <u>For more details about Candidate and to Verify Candidate :-</u>
            <br /> <br /> 
