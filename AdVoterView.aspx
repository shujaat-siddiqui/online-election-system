<%@ Page Title="Voter" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdVoterView.aspx.cs" Inherits="Online_Election_System.AdVoterView" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div style="height:1000px; background-color:#c8b9b9; padding-top:5%; padding-bottom:5%">
