<%@ Page Title="Update Email" Language="C#" MasterPageFile="~/Candidate.Master" AutoEventWireup="true" CodeBehind="CandidateUpdateEmail.aspx.cs" Inherits="Online_Election_System.CandidateUpdateEmail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="height:400px; width:100%; background-color:#c8b9b9">
        ...
        <div style="padding-top:50px; text-align:center; color:black; font-size:22px; font-family:Tahoma; font:bold" >
            ...
            <br /> <br /> <br /> <br /> 
            <asp:HyperLink ID="linktoupdate" runat="server" NavigateUrl="CandidateUpdateDetails.aspx">Click Here to Update Other details!</asp:HyperLink>
        </div>
