<%@ Page Title="Candidates List" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="CandidatesList.aspx.cs" Inherits="Online_Election_System.CandidatesList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="height:auto; width:auto; background-color:#c8b9b9">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=DESKTOP-SNGIH0I\SHUJAAT;Initial Catalog=OnlineElectionSystem;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [idnumber], [Name], [Gender], [DOB], [Party] FROM [Candidate]"></asp:SqlDataSource>

        </div>

        <div style="height:200px; width:500px; margin-top:5px; padding-left:4px; padding-top:4px; color:black; font-size:25px; font-family:Tahoma; font:bold">
            <u>For more details about Candidate :-</u>
            <br /> <br /> 
