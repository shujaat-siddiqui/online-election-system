...
{
    public partial class AdVoters : System.Web.UI.Page
    {
        ...
        {
            con.Open();
            cmd = new SqlCommand("select * from Voter where idnumber = '" + txt_idnumber.Text + "'", con);
            ...
            if (dr.HasRows)
            {
                ...
                Response.Redirect("AdVoterView.aspx");
            }
            else
            {
