<%@ Page Title="Profile" Language="C#" MasterPageFile="~/Candidate.Master" AutoEventWireup="true" CodeBehind="CandidateProfile.aspx.cs" Inherits="Online_Election_System.CandidateProfile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <div style="height:700px; background-color:#c8b9b9; padding-top:5%; padding-bottom:5%">
